    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <li style="color: #ff0909">{{ $errors }}</li>
                ...
                <form id="request" action="{{ url('contact') }}" method="POST" class="main_form">
                    ...
                    <div class="row">
                        <div class="col-md-12 ">
                            <input class="contactus" @if (Auth::id()) value="{{ Auth::user()->name }}" @endif
                                placeholder="Name" type="text" name="name" required>
                        </div>
                        <div class="col-md-12">
                            <input class="contactus" @if (Auth::id()) value="{{ Auth::user()->email }}" @endif
                                placeholder="Email" type="email" name="email" required>
                        </div>
                        <div class="col-md-12">
                            <input class="contactus" @if (Auth::id()) value="{{ Auth::user()->phone }}" @endif
                                placeholder="Phone Number" type="number" name="phone" required>
                        </div>
                        <div class="col-md-12">
